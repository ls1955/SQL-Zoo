...
-- 2. Show the institution and subject where the score
-- is at least 100 for question 15.
...
-- 4. Show the subject and total number of students who
-- responded to question 22 for each of the subjects
...
-- 5. 5. Show the subject and total number of students
-- who A_STRONGLY_AGREE to question 22 for each of the
...
-- 6. Show the percentage of students who A_STRONGLY_AGREE
-- to question 22 for the subject '(8) Computer Science'
...
-- 7. Show the average scores for question 'Q22' for each
...
-- 8. Show the institution, the total sample size and the
-- number of computing students for institutions in Manchester for 'Q01'.
