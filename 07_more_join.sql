...
-- 3. List all of the Star Trek movies, include
-- the id, title and yr (all of these movies
-- include the words Star Trek in the title).
...
-- casting gives the position of the actor. If ord = 1
...
-- 13. Obtain a list, in alphabetical order, of
-- actors who've had at least 15 starring roles.
SELECT actor.name
FROM actor
JOIN casting
ON actor.id = casting.actorid
